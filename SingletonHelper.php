...
class SingletonHelper
{
     ...
     *
     * @var array<string, Singleton>|null
     */
    private static ?array $singletonsBackup = null;
     ...
     *
     * @return array<string, Singleton>
     *   An associative array containing the backed-up Singleton instances,
     *   where the keys are class names (strings) and the values are instances
     *   of the `Singleton` subclass.
     * @throws \RuntimeException
     *   If Singletons are already backed up.
     */
    public static function BackupSingletons(): array
    {
     ...
     *
     * @param array<string, Singleton> $singletons
     *   An associative array containing the new subclass instances to be set,
     *   where the keys are class names (strings) and the values are instances
     *   of the `Singleton` subclass.
     * @return void
     * @throws \RuntimeException
     ...
     */
    public static function UpdateSingletons(array $singletons): void
    {
        if (self::$singletonsBackup === null) {
            throw new \RuntimeException('No Singleton backup found.');
        }
